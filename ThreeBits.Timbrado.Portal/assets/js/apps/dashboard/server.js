(function ()
{
    ...
    nv.addGraph(function ()
    {
        ...
        function initChart()
        {
            chartData = data.widget4.chart;
            chartd3.datum(chartData).call(chart);

            var lastIndex = chartData[0].values.length - 1,
                x = chartData[0].values[lastIndex].x;
